...
const AddRoomForm = ({ handelDates, dates, handelSubmit, setImagePreview, imagePreview, imageText, handelImage, loading }) => {
                                ...
                                <div className='flex flex-col w-max mx-auto text-center'>
                                    <label>
                                        ...
                                        <div className='bg-rose-500 text-white border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 hover:bg-rose-500'>
                                            {/* when we split with something(. / -) it returns an array according to the given . / - */}
